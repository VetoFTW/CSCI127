...
def main():
   ...
   """
   userInputSizeOfBoard = int(input("Enter size of checkerboard: "))
   userInputLocationX = int(input("Enter row to move piece to: "))
   userInputLocationY = int(input("Enter col to move piece to: "))

   drawBoard(userInputSizeOfBoard)
   setupScreen(userInputSizeOfBoard)

   myCheckerPiece = createPiece("red")

   movePiece(userInputSizeOfBoard, myCheckerPiece,
             userInputLocationX, userInputLocationY)
